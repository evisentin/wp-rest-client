package io.github.evisentin.wordpress.client.samples.okhttp.jwt;
...
import io.github.evisentin.wordpress.client.samples.okhttp.SampleHttpRequestInterceptor;
import io.github.evisentin.wordpress.client.samples.okhttp.SampleHttpResponseInterceptor;
 ...
 * </p>
 */
public class OkHttpListPostWithJwt {
    ...
    public static void main(String[] args) {
        ...
        final WpRestClient restClient =
                OkHttpWpRestClientBuilder.jwtAuthentication(BASE_URL, USER_NAME, PASSWORD, JWT_TOKEN_ENDPOINT)
