...
public class PageQueryParamMapper extends AbstractQueryParamMapper {
    /**
     * Maps the given {@link WpPageQuery} into query parameters and adds them to the provided {@link URIBuilder}.
     *
     ...
     */
    public static void map(final @NonNull URIBuilder builder, final WpPageQuery query) {
