 ...
 * {@link HttpUrl.Builder}. All methods are null-safe and only add parameters when values are present and valid.
 *
...
public abstract class AbstractQueryParamMapper {
    ...
    protected static void addBoolean(final HttpUrl.Builder builder,
                                     final String paramName, final Boolean value) {
        ofNullable(value)
                .map(Object::toString)
                .ifPresent(val -> builder.addQueryParameter(paramName, val));
    }

    protected static void addEnum(final HttpUrl.Builder builder,
    ...
    protected static void addInteger(final HttpUrl.Builder builder,
                                     final String paramName, final Integer value) {
        ofNullable(value)
                .ifPresent(val -> builder.addQueryParameter(paramName, val.toString()));
    }

    protected static void addLocalDate(final HttpUrl.Builder builder,
                                       final String paramName, final LocalDate value) {
        ofNullable(value)
                .ifPresent(val -> builder.addQueryParameter(paramName, val.format(DateTimeFormatter.ISO_LOCAL_DATE)));
    }

    protected static void addLong(final HttpUrl.Builder builder,
                                  final String paramName, final Long value) {
        ofNullable(value)
                .ifPresent(val -> builder.addQueryParameter(paramName, val.toString()));
    }

    protected static void addSetOfEnums(final HttpUrl.Builder builder,
    ...
    protected static void addSetOfLong(final HttpUrl.Builder builder,
    ...
    protected static void addSetOfStrings(final HttpUrl.Builder builder,
    ...
    protected static void addString(final HttpUrl.Builder builder,
