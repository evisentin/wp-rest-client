...
/**
 * Maps {@link WpPageQuery} into HTTP query parameters for post-related WordPress endpoints.
 *
...
public class PageQueryParamMapper extends AbstractQueryParamMapper {
    /**
     * Maps the given {@link WpPageQuery} into query parameters and adds them to the provided {@link HttpUrl.Builder}.
     *
     ...
     */
    public static void map(final @NonNull HttpUrl.Builder builder, final WpPageQuery query) {
        ...
        addLong(builder, PARENT, query.getParent());
        addSetOfLong(builder, PARENT_EXCLUDE, query.getExcludeParentIds());
        addLong(builder, MENU_ORDER, query.getMenuOrder());
    }
}
