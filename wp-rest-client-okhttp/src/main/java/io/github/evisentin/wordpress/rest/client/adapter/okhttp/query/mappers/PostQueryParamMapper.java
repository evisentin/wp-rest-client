...
public class PostQueryParamMapper extends AbstractQueryParamMapper {
    /**
     * Maps the given {@link WpPostQuery} into query parameters and adds them to the provided {@link HttpUrl.Builder}.
     *
     ...
     */
    public static void map(final @NonNull HttpUrl.Builder builder, final WpPostQuery query) {
