...
public class MediaQueryParamMapper extends AbstractQueryParamMapper {
    /**
     * Maps the given {@link WpMediaQuery} into query parameters and adds them to the provided {@link HttpUrl.Builder}.
     *
     ...
     */
    public static void map(final @NonNull HttpUrl.Builder builder, final WpMediaQuery query) {
