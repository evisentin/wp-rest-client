...
public abstract class AbstractWpPageAssert<S extends AbstractWpPageAssert<S>>
        extends AbstractObjectAssert<S, WpPage> {

    protected AbstractWpPageAssert(final WpPage actual, final Class<?> selfType) {
    ...
    public S hasDate(final LocalDateTime expected) {
        ...
        if (!java.util.Objects.equals(actual.getDate(), expected)) {
            failWithMessage("Expected page date to be <%s> but was <%s>", expected, actual.getDate());
        }
        return myself;
    }
    ...
    public S hasDateGMT(final LocalDateTime expected) {
        ...
        if (!java.util.Objects.equals(actual.getDateGMT(), expected)) {
            failWithMessage("Expected page dateGMT to be <%s> but was <%s>", expected, actual.getDateGMT());
        }
        return myself;
    }
    ...
    public S hasId() {
        ...
        if (actual.getId() == null) {
            failWithMessage("Expected page id to be non-null");
        }
    ...
    public S hasId(final Long expected) {
        ...
        if (!java.util.Objects.equals(actual.getId(), expected)) {
            failWithMessage("Expected page id to be <%s> but was <%s>", expected, actual.getId());
        }
        return myself;
    }
    ...
    public S hasLink(final String expected) {
        ...
        if (!java.util.Objects.equals(actual.getLink(), expected)) {
            failWithMessage("Expected page link to be <%s> but was <%s>", expected, actual.getLink());
        }
        return myself;
    }
    ...
    public S hasModified(final LocalDateTime expected) {
        ...
        if (!java.util.Objects.equals(actual.getModified(), expected)) {
            failWithMessage("Expected page modified to be <%s> but was <%s>", expected, actual.getModified());
        }
        return myself;
    }
    ...
    public S hasModifiedGMT(final LocalDateTime expected) {
        ...
        if (!java.util.Objects.equals(actual.getModifiedGMT(), expected)) {
            failWithMessage("Expected page modifiedGMT to be <%s> but was <%s>", expected, actual.getModifiedGMT());
        }
        return myself;
    }
    ...
    public S hasPassword(final String expected) {
        ...
        if (!java.util.Objects.equals(actual.getPassword(), expected)) {
            failWithMessage("Expected page password to be <%s> but was <%s>", expected, actual.getPassword());
        }
        return myself;
    }
    ...
    public S hasSlug(final String expected) {
        ...
        if (!java.util.Objects.equals(actual.getSlug(), expected)) {
            failWithMessage("Expected page slug to be <%s> but was <%s>", expected, actual.getSlug());
        }
        return myself;
    }

    public S hasStatus(final WpPageStatus expected) {
        isNotNull();
        if (!java.util.Objects.equals(actual.getStatus(), expected)) {
            failWithMessage("Expected page status to be <%s> but was <%s>", expected, actual.getStatus());
        }
        return myself;
    }
    ...
    public S hasType(final String expected) {
        ...
        if (!java.util.Objects.equals(actual.getType(), expected)) {
            failWithMessage("Expected page type to be <%s> but was <%s>", expected, actual.getType());
        }
        return myself;
    }
}
