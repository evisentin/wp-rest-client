...
class WpPagedResponseTest implements WithAssertions {
    ...
    void shouldNotReportNextPageWhenPageNumberEqualsTotalPages() {
        WpPagedResponse<String> response = new WpPagedResponse<>(List.of("item"), 10, 30, 3, 3);
    ...
    void shouldRejectItemsPerPageLessThanOne() {
        assertThatThrownBy(() -> new WpPagedResponse<>(List.of("item"), 0, 0, 0, 1))
    ...
    void shouldRejectNegativeTotalItems() {
        assertThatThrownBy(() -> new WpPagedResponse<>(List.of("item"), 10, -1, 0, 1))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void shouldRejectNegativeTotalPages() {
        assertThatThrownBy(() -> new WpPagedResponse<>(List.of("item"), 10, 0, -1, 1))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void shouldRejectPageNumberLessThanOne() {
        assertThatThrownBy(() -> new WpPagedResponse<>(List.of("item"), 10, 0, 0, 0))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void shouldReportEmptyWhenItemsListIsEmpty() {
        WpPagedResponse<String> response = new WpPagedResponse<>(List.of(), 10, 0, 0, 1);
    ...
    void shouldReportNextPageWhenPageNumberIsLessThanTotalPages() {
        WpPagedResponse<String> response = new WpPagedResponse<>(List.of("item"), 10, 30, 3, 2);
    ...
    void shouldReportNotEmptyWhenItemsListContainsElements() {
        WpPagedResponse<String> response = new WpPagedResponse<>(List.of("item"), 10, 1, 1, 1);
